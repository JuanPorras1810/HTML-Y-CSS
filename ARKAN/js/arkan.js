...
function getRanking() {
    const rawData = sessionStorage.getItem('arkanoid_ranking');
...
function saveScoreToRanking(finalScore) {
    ...
    sessionStorage.setItem('arkanoid_ranking', JSON.stringify(ranking));
    updateRankingUI();
}
...
function updateRankingUI() {
    ...
    ranking.forEach((points, index) => {
        ...
        // Asigna clases diferenciadas para los 3 primeros puestos
